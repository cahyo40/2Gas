...
abstract class AppLocalizations {
  ...
  /// No description provided for @activity_task_created_title.
  ///
  /// In en, this message translates to:
  /// **'New Task'**
  String get activity_task_created_title;

  /// No description provided for @activity_task_updated_title.
  ///
  /// In en, this message translates to:
  /// **'Task Updated'**
  String get activity_task_updated_title;

  /// No description provided for @activity_task_deleted_title.
  ///
  /// In en, this message translates to:
  /// **'Task Deleted'**
  String get activity_task_deleted_title;

  /// No description provided for @activity_task_moved_title.
  ///
  /// In en, this message translates to:
  /// **'Task Status Changed'**
  String get activity_task_moved_title;

  /// No description provided for @activity_project_created_title.
  ///
  /// In en, this message translates to:
  /// **'New Project'**
  String get activity_project_created_title;

  /// No description provided for @activity_project_updated_title.
  ///
  /// In en, this message translates to:
  /// **'Project Updated'**
  String get activity_project_updated_title;

  /// No description provided for @activity_project_deleted_title.
  ///
  /// In en, this message translates to:
  /// **'Project Deleted'**
  String get activity_project_deleted_title;

  /// No description provided for @activity_project_completed_title.
  ///
  /// In en, this message translates to:
  /// **'Project Completed'**
  String get activity_project_completed_title;

  /// No description provided for @activity_member_join_title.
  ///
  /// In en, this message translates to:
  /// **'New Member'**
  String get activity_member_join_title;

  /// No description provided for @activity_member_remove_title.
  ///
  /// In en, this message translates to:
  /// **'Member Removed'**
  String get activity_member_remove_title;

  /// No description provided for @activity_member_left_title.
  ///
  /// In en, this message translates to:
  /// **'Member Left'**
  String get activity_member_left_title;

  /// No description provided for @activity_member_change_role.
  ///
  /// In en, this message translates to:
  /// **'Member Role Changed'**
  String get activity_member_change_role;

  /// No description provided for @activity_project_comment_title.
  ///
  /// In en, this message translates to:
  /// **'New Comment'**
  String get activity_project_comment_title;

  /// No description provided for @activity_schedule_created_title.
  ///
  /// In en, this message translates to:
  /// **'New Schedule'**
  String get activity_schedule_created_title;

  /// No description provided for @activity_schedule_edited_title.
  ///
  /// In en, this message translates to:
  /// **'Schedule Changed'**
  String get activity_schedule_edited_title;

  /// No description provided for @activity_schedule_deleted_title.
  ///
  /// In en, this message translates to:
  /// **'Schedule Cancelled'**
  String get activity_schedule_deleted_title;

  /// No description provided for @activity_org_created_title.
  ///
  /// In en, this message translates to:
  /// **'New Organization'**
  String get activity_org_created_title;

  /// No description provided for @activity_org_updated_title.
  ///
  /// In en, this message translates to:
  /// **'Organization Updated'**
  String get activity_org_updated_title;

  /// No description provided for @activity_task_created_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} created task {taskName} in project {projectName}'**
  ...
  /// No description provided for @activity_task_updated_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} updated task {taskName} -> \"{info}\"'**
  String activity_task_updated_desc(String user, String taskName, String info);

  /// No description provided for @activity_task_deleted_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} deleted task {taskName} from project {projectName}'**
  ...
  /// No description provided for @activity_task_move_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} updated task {taskName} status -> {info}'**
  String activity_task_move_desc(String user, String taskName, String info);

  /// No description provided for @activity_project_created_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} created project {projectName}'**
  String activity_project_created_desc(String user, String projectName);

  /// No description provided for @activity_project_updated_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} updated project data -> {info}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Project completed on {info}'**
  String activity_project_completed_desc(String info);

  /// No description provided for @activity_member_join_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} joined {orgName}'**
  String activity_member_join_desc(String user, String orgName);

  /// No description provided for @activity_member_remove_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} removed {info}'**
  String activity_member_remove_desc(String user, String info);

  /// No description provided for @activity_member_left_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} left the organization'**
  String activity_member_left_desc(String user);

  /// No description provided for @activity_member_change_role_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} role changed to {info}'**
  String activity_member_change_role_desc(String user, String info);

  /// No description provided for @activity_project_comment_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} commented on project {project} -> \"{info}\"'**
  ...
  /// No description provided for @activity_schedule_created_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} created schedule {scheduleName}'**
  String activity_schedule_created_desc(String user, String scheduleName);

  /// No description provided for @activity_schedule_edited_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} edited schedule {scheduleName} -> {info}'**
  ...
  /// No description provided for @activity_schedule_deleted_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} cancelled schedule {scheduleName}'**
  String activity_schedule_deleted_desc(String user, String scheduleName);

  /// No description provided for @activity_org_created_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} created organization {orgName}'**
  String activity_org_created_desc(String user, String orgName);

  /// No description provided for @activity_org_updated_desc.
  ///
  /// In en, this message translates to:
  /// **'{user} updated organization data -> {info}'**
  ...
  /// No description provided for @demote_to_member.
  ///
  /// In en, this message translates to:
  /// **'Demote to Member'**
  String get demote_to_member;
  ...
  /// No description provided for @dialog_remove_member_title.
  ///
  /// In en, this message translates to:
  /// **'Remove Member'**
  String get dialog_remove_member_title;

  /// No description provided for @dialog_remove_member_content.
  ///
  /// In en, this message translates to:
